            ...
            <div class="card border-primary filterable">
                <div class="card-header bg-success text-white">
                    <div class="card-title d-inline pull-left">
                        <i class="fa fa-fw fa-file-text-o"></i> <b>{{__('Редактировать государственная категория ')}}</b>
                    </div>
                </div>
                <br>
                <form action="{{ route("admin.stateCategory.update", $stateCategory->id) }}" method="POST" >
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-md-12">
                            <div class="input-group input-ground-prepend">
                                ...
                                <input type="text" class="form-control" name="name" id="name"  value="{{$stateCategory->name}}">
                            </div>
                        </div>
                    </div>
